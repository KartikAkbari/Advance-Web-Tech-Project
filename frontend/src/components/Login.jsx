...
const Login = () => {
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center"
      ...
      <img
        className="w-[60%] h-[100vh] object-cover absolute"
      ...
      />
      <div className="w-[40%] flex justify-center items-start flex-col pl-8 z-10 m-auto mt-20">
      ...
      <div className="absolute top-4 right-4">
        <button
          className={`mr-6 text-base font-semibold ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${selected === "Student" && "border-b-2 border-green-500"
            }`}
        ...
        <button
          className={`mr-6 text-base font-semibold ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${selected === "Faculty" && "border-b-2 border-green-500"
            }`}
        ...
        <button
          className={`mr-6 text-base font-semibold ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${selected === "Admin" && "border-b-2 border-green-500"
            }`}
